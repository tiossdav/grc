export const UserTestimonial = () => {
  return (
    <>
      <section className="bg-[#006455] py-8 text-white text-center flex items-center flex-col flex-1 leading-4 space-y-3">
        ...
        <p className="italic font-semibold ">A user of GRC</p>
      </section>
    </>
  );
};
